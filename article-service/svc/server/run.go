...
func NewEndpoints(service pb.ArticleServer) svc.Endpoints {
	// Business domain.
	...
	var (
		...
		recordsEndpoint    = svc.MakeRecordsEndpoint(service)
		removeEndpoint     = svc.MakeRemoveEndpoint(service)
		topEndpoint        = svc.MakeTopEndpoint(service)
		recommendsEndpoint = svc.MakeRecommendsEndpoint(service)
		reviewEndpoint     = svc.MakeReviewEndpoint(service)
		publishEndpoint    = svc.MakePublishEndpoint(service)
		editEndpoint       = svc.MakeEditEndpoint(service)
	)
